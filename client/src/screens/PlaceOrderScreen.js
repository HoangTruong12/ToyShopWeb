...
const PlaceOrderScreen = () => {
  ...
  cart.shippingPrice = addDecimals(cart.itemsPrice > 15 ? 0 : 1.5);
  ...
  //   cart.cartItems.reduce((acc, item) => acc + item.price * item.qty, 0)
  // );
  // cart.shippingPrice = addDecimals(cart.itemsPrice > 150000 ? 0 : 35000);
          ...
          <div className="col-lg-8">
            {
              cart.cartItems.length === 0 ? (
                <Message variant="alert-info mt-5">Không có đơn hàng nào để thanh toán</Message>
              )
              :
              (
                <>
